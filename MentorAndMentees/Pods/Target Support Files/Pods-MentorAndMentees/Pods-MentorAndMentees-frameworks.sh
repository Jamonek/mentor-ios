...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "Pods-MentorAndMentees/RxCocoa.framework"
  install_framework "Pods-MentorAndMentees/RxSwift.framework"
  install_framework "Pods-MentorAndMentees/Spring.framework"
  install_framework "Pods-MentorAndMentees/TextFieldEffects.framework"
fi
